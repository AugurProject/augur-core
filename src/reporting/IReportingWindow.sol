...
contract IReportingWindow is Typed {
    ...
    function createNewMarket(uint256 _endTime, uint8 _numOutcomes, uint256 _numTicks, uint256 _feePerEthInWei, ICash _denominationToken, address _creator, address _automatedReporterAddress, bytes32 _topic) public payable returns (IMarket _newMarket);
    ...
    function hasReceivedAllReport(IMarket _market) public constant returns (bool);
