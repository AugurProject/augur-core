...
contract CancelOrder is Controlled, ReentrancyGuard, ICancelOrder {
     ...
     * @dev Issue refunds
     */
    function refundOrder(address _sender, Order.TradeTypes _type, uint256 _fxpSharesEscrowed, uint256 _fxpMoneyEscrowed, IMarket _market, uint8 _outcome) private returns (bool) {
