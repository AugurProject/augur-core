...
contract OrderBook is Controlled {
    ...
    function getOrderBook(Order.OrderTypes _type, IMarket _market, uint8 _outcome, bytes32 _startingOrderId, uint256 _numOrdersToLoad) constant public returns (uint256[] _orderBook) {
