...
contract CreateOrder is CashAutoConverter, Extractable, ReentrancyGuard, MarketValidator {
    ...
    function publicCreateOrder(Order.Types _type, uint256 _attoshares, uint256 _displayPrice, IMarket _market, uint8 _outcome, bytes32 _betterOrderId, bytes32 _worseOrderId, bytes32 _tradeGroupId) external payable marketIsValid(_market) convertToAndFromCash onlyInGoodTimes nonReentrant returns (bytes32) {
