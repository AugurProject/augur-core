...
contract ITrade {
    ...
    function publicTakeBestOrder(Order.TradeDirections _direction, IMarket _market, uint256 _outcome, uint256 _fxpAmount, uint256 _price, uint256 _tradeGroupID) external returns (uint256);
