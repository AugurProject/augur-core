...
contract CancelOrder is CashAutoConverter, ReentrancyGuard, ICancelOrder {
     ...
     */
    function cancelOrder(bytes32 _orderId, Order.OrderTypes _type, IMarket _market, uint8 _outcome) nonReentrant convertToAndFromCash external returns (bool) {
     ...
     * @dev Issue refunds
     */
    function refundOrder(address _sender, Order.OrderTypes _type, uint256 _sharesEscrowed, uint256 _moneyEscrowed, IMarket _market, uint8 _outcome) private returns (bool) {
