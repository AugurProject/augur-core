...
contract IReportingWindow is ITyped {
    ...
    function createMarket(uint256 _endTime, uint256 _feeDivisor, ICash _denominationToken, address _designatedReporterAddress, address _sender, uint8 _numOutcomes, uint256 _numTicks) public payable returns (IMarket _newMarket);
