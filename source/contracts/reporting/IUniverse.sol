...
contract IUniverse is ITyped {
    ...
    function logWinningTokensRedeemed(address _reporter, address _market, address _reportingToken, uint256 _amountRedeemed, address _reportingFeesReceived, uint256[] _payoutNumerators) public returns (bool);
