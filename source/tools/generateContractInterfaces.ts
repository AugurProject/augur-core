...
async function doWork(): Promise<void> {
    ...
    const contractABIs: CompilerOutput = JSON.parse(await fs.readFile(configuration.contractOutputPath, "utf8"));

    const fileContents: String = contractInterfacesTemplate(contractABIs.contracts);
