...
describe("TradeAndReport", () => {
    ...
    it("#tradeAndReport", async () => {
        ...
        const payoutDistributionHash = await fixture.derivePayoutDistributionHash(market, [numTicks, new BN(0), new BN(0)]);
        ...
        await fixture.migrateOutByPayout(reputationToken, [numTicks, new BN(0), new BN(0)], repAmountToMigrate);
