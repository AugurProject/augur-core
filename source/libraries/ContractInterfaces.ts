...
export class Augur extends Controlled {
    ...
    public logStakeTokenBurned = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logStakeTokenBurned_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logStakeTokenBurned","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logStakeTokensTransferred = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logStakeTokensTransferred_ = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"logStakeTokensTransferred","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logParticipationTokenBurned = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logParticipationTokenBurned_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logParticipationTokenBurned","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logStakeTokenMinted = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logStakeTokenMinted_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logStakeTokenMinted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logDesignatedReportSubmitted = async(universe: string, reporter: string, market: string, stakeToken: string, amountStaked: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logDesignatedReportSubmitted_ = async(universe: string, reporter: string, market: string, stakeToken: string, amountStaked: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_reporter","type":"address"},{"name":"_market","type":"address"},{"name":"_stakeToken","type":"address"},{"name":"_amountStaked","type":"uint256"},{"name":"_payoutNumerators","type":"uint256[]"}],"name":"logDesignatedReportSubmitted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logReputationTokenBurned = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logReputationTokenBurned_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logReputationTokenBurned","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logOrderFilled = async(universe: string, shareToken: string, filler: string, orderId: string, numCreatorShares: BN|number, numCreatorTokens: BN|number, numFillerShares: BN|number, numFillerTokens: BN|number, settlementFees: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logOrderFilled_ = async(universe: string, shareToken: string, filler: string, orderId: string, numCreatorShares: BN|number, numCreatorTokens: BN|number, numFillerShares: BN|number, numFillerTokens: BN|number, settlementFees: BN|number, tradeGroupId: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_shareToken","type":"address"},{"name":"_filler","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_numCreatorShares","type":"uint256"},{"name":"_numCreatorTokens","type":"uint256"},{"name":"_numFillerShares","type":"uint256"},{"name":"_numFillerTokens","type":"uint256"},{"name":"_settlementFees","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"logOrderFilled","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logTradingProceedsClaimed = async(universe: string, shareToken: string, sender: string, market: string, numShares: BN|number, numPayoutTokens: BN|number, finalTokenBalance: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logTradingProceedsClaimed_ = async(universe: string, shareToken: string, sender: string, market: string, numShares: BN|number, numPayoutTokens: BN|number, finalTokenBalance: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_shareToken","type":"address"},{"name":"_sender","type":"address"},{"name":"_market","type":"address"},{"name":"_numShares","type":"uint256"},{"name":"_numPayoutTokens","type":"uint256"},{"name":"_finalTokenBalance","type":"uint256"}],"name":"logTradingProceedsClaimed","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logOrderCanceled = async(universe: string, shareToken: string, sender: string, orderId: string, orderType: BN|number, tokenRefund: BN|number, sharesRefund: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logOrderCanceled_ = async(universe: string, shareToken: string, sender: string, orderId: string, orderType: BN|number, tokenRefund: BN|number, sharesRefund: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_shareToken","type":"address"},{"name":"_sender","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_orderType","type":"uint8"},{"name":"_tokenRefund","type":"uint256"},{"name":"_sharesRefund","type":"uint256"}],"name":"logOrderCanceled","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logParticipationTokensTransferred = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logParticipationTokensTransferred_ = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"logParticipationTokensTransferred","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, from, to, value], options.sender);
        return <boolean>result[0];
    ...
    public logReputationTokenMinted = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logReputationTokenMinted_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logReputationTokenMinted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logMarketCreated = async(universe: string, market: string, marketCreator: string, marketCreationFee: BN|number, extraInfo: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_market","type":"address"},{"name":"_marketCreator","type":"address"},{"name":"_marketCreationFee","type":"uint256"},{"name":"_extraInfo","type":"string"}],"name":"logMarketCreated","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [universe, market, marketCreator, marketCreationFee, extraInfo], options.sender, options.gasPrice);
    }

    public logMarketCreated_ = async(universe: string, market: string, marketCreator: string, marketCreationFee: BN|number, extraInfo: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_market","type":"address"},{"name":"_marketCreator","type":"address"},{"name":"_marketCreationFee","type":"uint256"},{"name":"_extraInfo","type":"string"}],"name":"logMarketCreated","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, market, marketCreator, marketCreationFee, extraInfo], options.sender);
        return <boolean>result[0];
    }

    public logShareTokensTransferred = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logShareTokensTransferred_ = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"logShareTokensTransferred","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, from, to, value], options.sender);
        return <boolean>result[0];
    ...
    public logOrderCreated = async(universe: string, shareToken: string, creator: string, orderId: string, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logOrderCreated_ = async(universe: string, shareToken: string, creator: string, orderId: string, tradeGroupId: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_shareToken","type":"address"},{"name":"_creator","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"logOrderCreated","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logReportSubmitted = async(universe: string, reporter: string, market: string, stakeToken: string, amountStaked: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logReportSubmitted_ = async(universe: string, reporter: string, market: string, stakeToken: string, amountStaked: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_reporter","type":"address"},{"name":"_market","type":"address"},{"name":"_stakeToken","type":"address"},{"name":"_amountStaked","type":"uint256"},{"name":"_payoutNumerators","type":"uint256[]"}],"name":"logReportSubmitted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, reporter, market, stakeToken, amountStaked, payoutNumerators], options.sender);
        return <boolean>result[0];
    ...
    public logShareTokenBurned = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logShareTokenBurned_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logShareTokenBurned","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logShareTokenMinted = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logShareTokenMinted_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logShareTokenMinted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logParticipationTokenMinted = async(universe: string, target: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logParticipationTokenMinted_ = async(universe: string, target: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_target","type":"address"},{"name":"_amount","type":"uint256"}],"name":"logParticipationTokenMinted","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, target, amount], options.sender);
        return <boolean>result[0];
    ...
    public logReportsDisputed = async(universe: string, disputer: string, market: string, reportingPhase: BN|number, disputeBondAmount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logReportsDisputed_ = async(universe: string, disputer: string, market: string, reportingPhase: BN|number, disputeBondAmount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_disputer","type":"address"},{"name":"_market","type":"address"},{"name":"_reportingPhase","type":"uint8"},{"name":"_disputeBondAmount","type":"uint256"}],"name":"logReportsDisputed","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public trustedTransfer = async(token: string, from: string, to: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedTransfer_ = async(token: string, from: string, to: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_token","type":"address"},{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_amount","type":"uint256"}],"name":"trustedTransfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public logReputationTokensTransferred = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logReputationTokensTransferred_ = async(universe: string, from: string, to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"logReputationTokensTransferred","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [universe, from, to, value], options.sender);
        return <boolean>result[0];
    ...
    public logWinningTokensRedeemed = async(universe: string, reporter: string, market: string, stakeToken: string, amountRedeemed: BN|number, reportingFeesReceived: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public logWinningTokensRedeemed_ = async(universe: string, reporter: string, market: string, stakeToken: string, amountRedeemed: BN|number, reportingFeesReceived: BN|number, payoutNumerators: Array<BN|number>, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_reporter","type":"address"},{"name":"_market","type":"address"},{"name":"_stakeToken","type":"address"},{"name":"_amountRedeemed","type":"uint256"},{"name":"_reportingFeesReceived","type":"uint256"},{"name":"_payoutNumerators","type":"uint256[]"}],"name":"logWinningTokensRedeemed","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IControlled extends Controlled {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class LegacyReputationToken extends Contract {
    ...
    public approve = async(spender: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public approve_ = async(spender: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_spender","type":"address"},{"name":"_value","type":"uint256"}],"name":"approve","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public transferFrom = async(from: string, to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public transferFrom_ = async(from: string, to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_from","type":"address"},{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"transferFrom","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public transfer = async(to: string, value: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public transfer_ = async(to: string, value: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_to","type":"address"},{"name":"_value","type":"uint256"}],"name":"transfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class DisputeBondFactory extends Contract {
    ...
    public createDisputeBond = async(controller: string, market: string, bondHolder: string, bondAmount: BN|number, payoutDistributionHash: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createDisputeBond_ = async(controller: string, market: string, bondHolder: string, bondAmount: BN|number, payoutDistributionHash: string, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_controller","type":"address"},{"name":"_market","type":"address"},{"name":"_bondHolder","type":"address"},{"name":"_bondAmount","type":"uint256"},{"name":"_payoutDistributionHash","type":"bytes32"}],"name":"createDisputeBond","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class MarketFactory extends Contract {
    ...
    public createMarket = async(controller: string, reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feePerEthInWei: BN|number, denominationToken: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createMarket_ = async(controller: string, reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feePerEthInWei: BN|number, denominationToken: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_controller","type":"address"},{"name":"_reportingWindow","type":"address"},{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feePerEthInWei","type":"uint256"},{"name":"_denominationToken","type":"address"},{"name":"_creator","type":"address"},{"name":"_designatedReporterAddress","type":"address"}],"name":"createMarket","outputs":[{"name":"_market","type":"address"}],"payable":true,"stateMutability":"payable","type":"function"};
...
export class ReportingWindowFactory extends Contract {
    ...
    public createReportingWindow = async(controller: string, universe: string, reportingWindowId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createReportingWindow_ = async(controller: string, universe: string, reportingWindowId: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_controller","type":"address"},{"name":"_universe","type":"address"},{"name":"_reportingWindowId","type":"uint256"}],"name":"createReportingWindow","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class ShareTokenFactory extends Contract {
    ...
    public createShareToken = async(controller: string, market: string, outcome: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createShareToken_ = async(controller: string, market: string, outcome: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_controller","type":"address"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"}],"name":"createShareToken","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class StakeTokenFactory extends Contract {
    ...
    public createStakeToken = async(controller: string, market: string, payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createStakeToken_ = async(controller: string, market: string, payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_controller","type":"address"},{"name":"_market","type":"address"},{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_invalid","type":"bool"}],"name":"createStakeToken","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class CashAutoConverter extends Controlled {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class DelegationTarget extends Controlled {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class Extractable extends Controlled {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class IOwnable extends Contract {
    ...
    public transferOwnership = async(ewOwner: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"newOwner","type":"address"}],"name":"transferOwnership","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [ewOwner], options.sender, options.gasPrice);
    }

    public transferOwnership_ = async(ewOwner: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"newOwner","type":"address"}],"name":"transferOwnership","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [ewOwner], options.sender);
        return <boolean>result[0];
    }
}

export class ITyped extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class Map extends Controlled {
    ...
    public add = async(key: string, value: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public remove = async(key: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize = async(owner: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        ...
        return await this.remoteCall(abi, [owner], options.sender, options.gasPrice);
    }
...
export class ERC20 extends Contract {
    ...
    public balanceOf_ = async(who: string, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_who","type":"address"}],"name":"balanceOf","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"};
...
export class VariableSupplyToken extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class DisputeBond extends Controlled {
    ...
    public initialize = async(market: string, bondHolder: string, bondAmount: BN|number, payoutDistributionHash: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize_ = async(market: string, bondHolder: string, bondAmount: BN|number, payoutDistributionHash: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_bondHolder","type":"address"},{"name":"_bondAmount","type":"uint256"},{"name":"_payoutDistributionHash","type":"bytes32"}],"name":"initialize","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IDisputeBond extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class IMarket extends Contract {
    ...
    public initialize = async(reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feeDivisor: BN|number, cash: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reportingWindow","type":"address"},{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feeDivisor","type":"uint256"},{"name":"_cash","type":"address"},{"name":"_creator","type":"address"},{"name":"_designatedReporterAddress","type":"address"}],"name":"initialize","outputs":[{"name":"_success","type":"bool"}],"payable":true,"stateMutability":"payable","type":"function"};
        return await this.remoteCall(abi, [reportingWindow, endTime, numOutcomes, numTicks, feeDivisor, cash, creator, designatedReporterAddress], options.sender, options.gasPrice, options.attachedEth);
    }

    public initialize_ = async(reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feeDivisor: BN|number, cash: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, attachedEth?: BN }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reportingWindow","type":"address"},{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feeDivisor","type":"uint256"},{"name":"_cash","type":"address"},{"name":"_creator","type":"address"},{"name":"_designatedReporterAddress","type":"address"}],"name":"initialize","outputs":[{"name":"_success","type":"bool"}],"payable":true,"stateMutability":"payable","type":"function"};
        const result = await this.localCall(abi, [reportingWindow, endTime, numOutcomes, numTicks, feeDivisor, cash, creator, designatedReporterAddress], options.sender, options.attachedEth);
        return <boolean>result[0];
    }

    public derivePayoutDistributionHash_ = async(payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string }): Promise<string> => {
        options = options || {};
    ...
    public getShareToken_ = async(outcome: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
    ...
    public isContainerForDisputeBond_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForDisputeBond","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }
    ...
    public isContainerForShareToken_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForShareToken","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }
    ...
    public increaseTotalStake = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public increaseTotalStake_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"increaseTotalStake","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public isContainerForStakeToken_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForStakeToken","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }
    ...
    public decreaseExtraDisputeBondRemainingToBePaidOut = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public decreaseExtraDisputeBondRemainingToBePaidOut_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"decreaseExtraDisputeBondRemainingToBePaidOut","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
...
export class IParticipationToken extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class IRegistrationToken extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public getPeakSupply_ = async( options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[],"name":"getPeakSupply","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [], options.sender);
        return <BN>result[0];
    }
...
export class IRepPriceOracle extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public setRepPriceInAttoEth = async(repPriceInAttoEth: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public setRepPriceInAttoEth_ = async(repPriceInAttoEth: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_repPriceInAttoEth","type":"uint256"}],"name":"setRepPriceInAttoEth","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IReportingWindow extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public createMarket = async(endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feeDivisor: BN|number, denominationToken: string, designatedReporterAddress: string, extraInfo: string, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feeDivisor","type":"uint256"},{"name":"_denominationToken","type":"address"},{"name":"_designatedReporterAddress","type":"address"},{"name":"_extraInfo","type":"string"}],"name":"createMarket","outputs":[{"name":"_newMarket","type":"address"}],"payable":true,"stateMutability":"payable","type":"function"};
        return await this.remoteCall(abi, [endTime, numOutcomes, numTicks, feeDivisor, denominationToken, designatedReporterAddress, extraInfo], options.sender, options.gasPrice, options.attachedEth);
    }

    public createMarket_ = async(endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feeDivisor: BN|number, denominationToken: string, designatedReporterAddress: string, extraInfo: string, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feeDivisor","type":"uint256"},{"name":"_denominationToken","type":"address"},{"name":"_designatedReporterAddress","type":"address"},{"name":"_extraInfo","type":"string"}],"name":"createMarket","outputs":[{"name":"_newMarket","type":"address"}],"payable":true,"stateMutability":"payable","type":"function"};
        const result = await this.localCall(abi, [endTime, numOutcomes, numTicks, feeDivisor, denominationToken, designatedReporterAddress, extraInfo], options.sender, options.attachedEth);
        return <string>result[0];
    }
    ...
    public collectStakeTokenReportingFees = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public collectStakeTokenReportingFees_ = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reporterAddress","type":"address"},{"name":"_attoStake","type":"uint256"},{"name":"_forgoFees","type":"bool"}],"name":"collectStakeTokenReportingFees","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public collectParticipationTokenReportingFees = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public collectParticipationTokenReportingFees_ = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reporterAddress","type":"address"},{"name":"_attoStake","type":"uint256"},{"name":"_forgoFees","type":"bool"}],"name":"collectParticipationTokenReportingFees","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [reporterAddress, attoStake, forgoFees], options.sender);
        return <BN>result[0];
    ...
    public isContainerForParticipationToken_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForParticipationToken","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }

    public isContainerForMarket_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForMarket","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }
    ...
    public increaseTotalWinningStake = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public increaseTotalWinningStake_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"increaseTotalWinningStake","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public getNextReportingWindow = async( options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[],"name":"getNextReportingWindow","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [], options.sender, options.gasPrice);
    }
    ...
    public collectDisputeBondReportingFees = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public collectDisputeBondReportingFees_ = async(reporterAddress: string, attoStake: BN|number, forgoFees: boolean, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reporterAddress","type":"address"},{"name":"_attoStake","type":"uint256"},{"name":"_forgoFees","type":"bool"}],"name":"collectDisputeBondReportingFees","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [reporterAddress, attoStake, forgoFees], options.sender);
        return <BN>result[0];
    ...
    public initialize = async(universe: string, reportingWindowId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize_ = async(universe: string, reportingWindowId: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_universe","type":"address"},{"name":"_reportingWindowId","type":"uint256"}],"name":"initialize","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IReputationToken extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public trustedReportingWindowTransfer = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedReportingWindowTransfer_ = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_source","type":"address"},{"name":"_destination","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"trustedReportingWindowTransfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public migrateOutStakeToken = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public migrateOutStakeToken_ = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_destination","type":"address"},{"name":"_reporter","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"migrateOutStakeToken","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public migrateIn = async(reporter: string, attotokens: BN|number, bonusIfInForkWindow: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public migrateIn_ = async(reporter: string, attotokens: BN|number, bonusIfInForkWindow: boolean, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reporter","type":"address"},{"name":"_attotokens","type":"uint256"},{"name":"_bonusIfInForkWindow","type":"bool"}],"name":"migrateIn","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public migrateOutDisputeBond = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public migrateOutDisputeBond_ = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_destination","type":"address"},{"name":"_reporter","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"migrateOutDisputeBond","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [destination, reporter, attotokens], options.sender);
        return <boolean>result[0];
    ...
    public mintForDisputeBondMigration = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public mintForDisputeBondMigration_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"mintForDisputeBondMigration","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public migrateOut = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public migrateOut_ = async(destination: string, reporter: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_destination","type":"address"},{"name":"_reporter","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"migrateOut","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [destination, reporter, attotokens], options.sender);
        return <boolean>result[0];
    ...
    public trustedStakeTokenTransfer = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedStakeTokenTransfer_ = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_source","type":"address"},{"name":"_destination","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"trustedStakeTokenTransfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [source, destination, attotokens], options.sender);
        return <boolean>result[0];
    ...
    public trustedMarketTransfer = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedMarketTransfer_ = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_source","type":"address"},{"name":"_destination","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"trustedMarketTransfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [source, destination, attotokens], options.sender);
        return <boolean>result[0];
    ...
    public trustedParticipationTokenTransfer = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedParticipationTokenTransfer_ = async(source: string, destination: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_source","type":"address"},{"name":"_destination","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"trustedParticipationTokenTransfer","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [source, destination, attotokens], options.sender);
        return <boolean>result[0];
...
export class IStakeToken extends Contract {
    ...
    public getPayoutNumerator_ = async(ndex: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
    ...
    public initialize = async(market: string, payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize_ = async(market: string, payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_invalid","type":"bool"}],"name":"initialize","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public trustedBuy = async(reporter: string, attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public trustedBuy_ = async(reporter: string, attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reporter","type":"address"},{"name":"_attotokens","type":"uint256"}],"name":"trustedBuy","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IUniverse extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public getDesignatedReportNoShowBond = async( options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[],"name":"getDesignatedReportNoShowBond","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [], options.sender, options.gasPrice);
    }
    ...
    public getReportingFeeDivisor = async( options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[],"name":"getReportingFeeDivisor","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [], options.sender, options.gasPrice);
    }
    ...
    public getDesignatedReportStake = async( options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[],"name":"getDesignatedReportStake","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [], options.sender, options.gasPrice);
    }
    ...
    public decreaseRepAvailableForExtraBondPayouts = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public decreaseRepAvailableForExtraBondPayouts_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"decreaseRepAvailableForExtraBondPayouts","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public getReportingWindowForForkEndTime = async( options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[],"name":"getReportingWindowForForkEndTime","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [], options.sender, options.gasPrice);
    }
    ...
    public isContainerForReportingWindow_ = async(shadyTarget: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_shadyTarget","type":"address"}],"name":"isContainerForReportingWindow","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [shadyTarget], options.sender);
        return <boolean>result[0];
    }
    ...
    public calculateFloatingValue_ = async(badMarkets: BN|number, totalMarkets: BN|number, targetDivisor: BN|number, previousValue: BN|number, defaultValue: BN|number, floor: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
    ...
    public getReportingWindowByTimestamp = async(timestamp: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_timestamp","type":"uint256"}],"name":"getReportingWindowByTimestamp","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [timestamp], options.sender, options.gasPrice);
    }

    public getReportingWindowByTimestamp_ = async(timestamp: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_timestamp","type":"uint256"}],"name":"getReportingWindowByTimestamp","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public decrementOpenInterest = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public decrementOpenInterest_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"decrementOpenInterest","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public incrementOpenInterest = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public incrementOpenInterest_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"incrementOpenInterest","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
    ...
    public increaseRepAvailableForExtraBondPayouts = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public increaseRepAvailableForExtraBondPayouts_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"increaseRepAvailableForExtraBondPayouts","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
...
export class Market extends Controlled {
    ...
    public initialize = async(reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feePerEthInAttoeth: BN|number, cash: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize_ = async(reportingWindow: string, endTime: BN|number, numOutcomes: BN|number, numTicks: BN|number, feePerEthInAttoeth: BN|number, cash: string, creator: string, designatedReporterAddress: string, options?: { sender?: string, attachedEth?: BN }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_reportingWindow","type":"address"},{"name":"_endTime","type":"uint256"},{"name":"_numOutcomes","type":"uint8"},{"name":"_numTicks","type":"uint256"},{"name":"_feePerEthInAttoeth","type":"uint256"},{"name":"_cash","type":"address"},{"name":"_creator","type":"address"},{"name":"_designatedReporterAddress","type":"address"}],"name":"initialize","outputs":[{"name":"_success","type":"bool"}],"payable":true,"stateMutability":"payable","type":"function"};
    ...
    public disputeDesignatedReport = async(payoutNumerators: Array<BN|number>, attotokens: BN|number, invalid: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public disputeDesignatedReport_ = async(payoutNumerators: Array<BN|number>, attotokens: BN|number, invalid: boolean, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_attotokens","type":"uint256"},{"name":"_invalid","type":"bool"}],"name":"disputeDesignatedReport","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public getStakeToken = async(payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_invalid","type":"bool"}],"name":"getStakeToken","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [payoutNumerators, invalid], options.sender, options.gasPrice);
    }

    public getStakeToken_ = async(payoutNumerators: Array<BN|number>, invalid: boolean, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_invalid","type":"bool"}],"name":"getStakeToken","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [payoutNumerators, invalid], options.sender);
        return <string>result[0];
    ...
    public disputeFirstReporters = async(payoutNumerators: Array<BN|number>, attotokens: BN|number, invalid: boolean, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public disputeFirstReporters_ = async(payoutNumerators: Array<BN|number>, attotokens: BN|number, invalid: boolean, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_payoutNumerators","type":"uint256[]"},{"name":"_attotokens","type":"uint256"},{"name":"_invalid","type":"bool"}],"name":"disputeFirstReporters","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [payoutNumerators, attotokens, invalid], options.sender);
        return <boolean>result[0];
...
export class ParticipationToken extends Controlled {
    ...
    public buy = async(attotokens: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public buy_ = async(attotokens: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_attotokens","type":"uint256"}],"name":"buy","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class StakeToken extends Controlled {
    ...
    public payoutNumerators_ = async(arg0: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
...
export class Universe extends Controlled {
    ...
    public getReportingWindowId_ = async(timestamp: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
    ...
    public getReportingWindow_ = async(reportingWindowId: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
...
export class CancelOrder extends Controlled {
    ...
    public cancelOrder = async(orderId: string, type: BN|number, market: string, outcome: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public cancelOrder_ = async(orderId: string, type: BN|number, market: string, outcome: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_orderId","type":"bytes32"},{"name":"_type","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"}],"name":"cancelOrder","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class Cash extends Controlled {
    ...
    public withdrawEtherTo = async(to: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public withdrawEtherTo_ = async(to: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_to","type":"address"},{"name":"_amount","type":"uint256"}],"name":"withdrawEtherTo","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public withdrawEther = async(amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public withdrawEther_ = async(amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"withdrawEther","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [amount], options.sender);
        return <boolean>result[0];
...
export class ClaimTradingProceeds extends Controlled {
    ...
    public divideUpWinnings = async(market: string, winningStakeToken: string, outcome: BN|number, numberOfShares: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public divideUpWinnings_ = async(market: string, winningStakeToken: string, outcome: BN|number, numberOfShares: BN|number, options?: { sender?: string }): Promise<Array<string>> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_winningStakeToken","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_numberOfShares","type":"uint256"}],"name":"divideUpWinnings","outputs":[{"name":"_proceeds","type":"uint256"},{"name":"_shareHolderShare","type":"uint256"},{"name":"_creatorShare","type":"uint256"},{"name":"_reporterShare","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public calculateCreatorFee_ = async(market: string, amount: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
    ...
    public calculateReportingFee = async(market: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public calculateReportingFee_ = async(market: string, amount: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"}],"name":"calculateReportingFee","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [market, amount], options.sender);
        return <BN>result[0];
    ...
    public calculateProceeds_ = async(winningStakeToken: string, outcome: BN|number, numberOfShares: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
...
export class CompleteSets extends Controlled {
    ...
    public sellCompleteSets = async(sender: string, market: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public sellCompleteSets_ = async(sender: string, market: string, amount: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_sender","type":"address"},{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"}],"name":"sellCompleteSets","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public buyCompleteSets = async(sender: string, market: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public buyCompleteSets_ = async(sender: string, market: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_sender","type":"address"},{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"}],"name":"buyCompleteSets","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [sender, market, amount], options.sender);
        return <boolean>result[0];
    ...
    public publicBuyCompleteSets = async(market: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicBuyCompleteSets_ = async(market: string, amount: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"}],"name":"publicBuyCompleteSets","outputs":[{"name":"","type":"bool"}],"payable":true,"stateMutability":"payable","type":"function"};
    ...
    public publicSellCompleteSets = async(market: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicSellCompleteSets_ = async(market: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"}],"name":"publicSellCompleteSets","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [market, amount], options.sender);
        return <boolean>result[0];
...
export class CreateOrder extends Controlled {
    ...
    public publicCreateOrder = async(type: BN|number, attoshares: BN|number, displayPrice: BN|number, market: string, outcome: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicCreateOrder_ = async(type: BN|number, attoshares: BN|number, displayPrice: BN|number, market: string, outcome: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_attoshares","type":"uint256"},{"name":"_displayPrice","type":"uint256"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicCreateOrder","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
    ...
    public createOrder = async(creator: string, type: BN|number, attoshares: BN|number, displayPrice: BN|number, market: string, outcome: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createOrder_ = async(creator: string, type: BN|number, attoshares: BN|number, displayPrice: BN|number, market: string, outcome: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_creator","type":"address"},{"name":"_type","type":"uint8"},{"name":"_attoshares","type":"uint256"},{"name":"_displayPrice","type":"uint256"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"createOrder","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class FillOrder extends Controlled {
    ...
    public fillOrder = async(filler: string, orderId: string, amountFillerWants: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public fillOrder_ = async(filler: string, orderId: string, amountFillerWants: BN|number, tradeGroupId: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_filler","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_amountFillerWants","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"fillOrder","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public publicFillOrder = async(orderId: string, amountFillerWants: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicFillOrder_ = async(orderId: string, amountFillerWants: BN|number, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_orderId","type":"bytes32"},{"name":"_amountFillerWants","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicFillOrder","outputs":[{"name":"","type":"uint256"}],"payable":true,"stateMutability":"payable","type":"function"};
...
export class ICash extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class ICompleteSets extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
...
export class ICreateOrder extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public publicCreateOrder = async(arg0: BN|number, arg1: BN|number, arg2: BN|number, arg3: string, arg4: BN|number, arg5: string, arg6: string, arg7: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"uint8"},{"name":"","type":"uint256"},{"name":"","type":"uint256"},{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"bytes32"},{"name":"","type":"bytes32"},{"name":"","type":"uint256"}],"name":"publicCreateOrder","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
        return await this.remoteCall(abi, [arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7], options.sender, options.gasPrice, options.attachedEth);
    }

    public publicCreateOrder_ = async(arg0: BN|number, arg1: BN|number, arg2: BN|number, arg3: string, arg4: BN|number, arg5: string, arg6: string, arg7: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"uint8"},{"name":"","type":"uint256"},{"name":"","type":"uint256"},{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"bytes32"},{"name":"","type":"bytes32"},{"name":"","type":"uint256"}],"name":"publicCreateOrder","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
        const result = await this.localCall(abi, [arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7], options.sender, options.attachedEth);
        return <string>result[0];
    }

    public createOrder = async(arg0: string, arg1: BN|number, arg2: BN|number, arg3: BN|number, arg4: string, arg5: BN|number, arg6: string, arg7: string, arg8: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"uint256"},{"name":"","type":"uint256"},{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"bytes32"},{"name":"","type":"bytes32"},{"name":"","type":"uint256"}],"name":"createOrder","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8], options.sender, options.gasPrice);
    }

    public createOrder_ = async(arg0: string, arg1: BN|number, arg2: BN|number, arg3: BN|number, arg4: string, arg5: BN|number, arg6: string, arg7: string, arg8: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"uint256"},{"name":"","type":"uint256"},{"name":"","type":"address"},{"name":"","type":"uint8"},{"name":"","type":"bytes32"},{"name":"","type":"bytes32"},{"name":"","type":"uint256"}],"name":"createOrder","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8], options.sender);
        return <string>result[0];
    }
}

export class IFillOrder extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public fillOrder = async(filler: string, orderId: string, amountFillerWants: BN|number, radeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_filler","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_amountFillerWants","type":"uint256"},{"name":"tradeGroupId","type":"uint256"}],"name":"fillOrder","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [filler, orderId, amountFillerWants, radeGroupId], options.sender, options.gasPrice);
    }

    public fillOrder_ = async(filler: string, orderId: string, amountFillerWants: BN|number, radeGroupId: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_filler","type":"address"},{"name":"_orderId","type":"bytes32"},{"name":"_amountFillerWants","type":"uint256"},{"name":"tradeGroupId","type":"uint256"}],"name":"fillOrder","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [filler, orderId, amountFillerWants, radeGroupId], options.sender);
        return <BN>result[0];
    }
...
export class IOrders extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public assertIsNotBetterPrice_ = async(type: BN|number, price: BN|number, betterOrderId: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
    ...
    public getOrderId_ = async(type: BN|number, market: string, fxpAmount: BN|number, price: BN|number, sender: string, blockNumber: BN|number, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":true,"inputs":[{"name":"_type","type":"uint8"},{"name":"_market","type":"address"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_sender","type":"address"},{"name":"_blockNumber","type":"uint256"},{"name":"_outcome","type":"uint8"},{"name":"_moneyEscrowed","type":"uint256"},{"name":"_sharesEscrowed","type":"uint256"}],"name":"getOrderId","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"view","type":"function"};
        const result = await this.localCall(abi, [type, market, fxpAmount, price, sender, blockNumber, outcome, moneyEscrowed, sharesEscrowed], options.sender);
        return <string>result[0];
    }
    ...
    public assertIsNotWorsePrice = async(type: BN|number, price: BN|number, worseOrderId: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public assertIsNotWorsePrice_ = async(type: BN|number, price: BN|number, worseOrderId: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_price","type":"uint256"},{"name":"_worseOrderId","type":"bytes32"}],"name":"assertIsNotWorsePrice","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public getBestOrderId_ = async(type: BN|number, market: string, outcome: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
    ...
    public isBetterPrice_ = async(type: BN|number, price: BN|number, orderId: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
    ...
    public fillOrder = async(orderId: string, sharesFilled: BN|number, tokensFilled: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public fillOrder_ = async(orderId: string, sharesFilled: BN|number, tokensFilled: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_orderId","type":"bytes32"},{"name":"_sharesFilled","type":"uint256"},{"name":"_tokensFilled","type":"uint256"}],"name":"fillOrder","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public getLastOutcomePrice_ = async(market: string, outcome: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
    ...
    public getWorstOrderId_ = async(type: BN|number, market: string, outcome: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
    ...
    public setPrice = async(market: string, outcome: BN|number, price: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public setPrice_ = async(market: string, outcome: BN|number, price: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_price","type":"uint256"}],"name":"setPrice","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public isWorsePrice_ = async(type: BN|number, price: BN|number, orderId: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
    ...
    public saveOrder = async(type: BN|number, market: string, fxpAmount: BN|number, price: BN|number, sender: string, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_market","type":"address"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_sender","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_moneyEscrowed","type":"uint256"},{"name":"_sharesEscrowed","type":"uint256"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"saveOrder","outputs":[{"name":"_orderId","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [type, market, fxpAmount, price, sender, outcome, moneyEscrowed, sharesEscrowed, betterOrderId, worseOrderId, tradeGroupId], options.sender, options.gasPrice);
    }

    public saveOrder_ = async(type: BN|number, market: string, fxpAmount: BN|number, price: BN|number, sender: string, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_market","type":"address"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_sender","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_moneyEscrowed","type":"uint256"},{"name":"_sharesEscrowed","type":"uint256"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"saveOrder","outputs":[{"name":"_orderId","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [type, market, fxpAmount, price, sender, outcome, moneyEscrowed, sharesEscrowed, betterOrderId, worseOrderId, tradeGroupId], options.sender);
        return <string>result[0];
    }
}

export class IOrdersFetcher extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public findBoundingOrders = async(type: BN|number, price: BN|number, bestOrderId: string, worstOrderId: string, betterOrderId: string, worseOrderId: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public findBoundingOrders_ = async(type: BN|number, price: BN|number, bestOrderId: string, worstOrderId: string, betterOrderId: string, worseOrderId: string, options?: { sender?: string }): Promise<Array<string>> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_price","type":"uint256"},{"name":"_bestOrderId","type":"bytes32"},{"name":"_worstOrderId","type":"bytes32"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"}],"name":"findBoundingOrders","outputs":[{"name":"","type":"bytes32"},{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class IShareToken extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }
    ...
    public createShares = async(owner: string, amount: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_owner","type":"address"},{"name":"_amount","type":"uint256"}],"name":"createShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [owner, amount], options.sender, options.gasPrice);
    }

    public createShares_ = async(owner: string, amount: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_owner","type":"address"},{"name":"_amount","type":"uint256"}],"name":"createShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [owner, amount], options.sender);
        return <boolean>result[0];
    }
    ...
    public initialize = async(market: string, outcome: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public initialize_ = async(market: string, outcome: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"}],"name":"initialize","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [market, outcome], options.sender);
        return <boolean>result[0];
    ...
    public destroyShares = async(arg0: string, alance: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"},{"name":"balance","type":"uint256"}],"name":"destroyShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [arg0, alance], options.sender, options.gasPrice);
    }

    public destroyShares_ = async(arg0: string, alance: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"},{"name":"balance","type":"uint256"}],"name":"destroyShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [arg0, alance], options.sender);
        return <boolean>result[0];
    }
...
export class ITrade extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public publicTakeBestOrder = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        ...
        return await this.remoteCall(abi, [direction, market, outcome, fxpAmount, price, tradeGroupID], options.sender, options.gasPrice);
    }

    public publicTakeBestOrder_ = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_direction","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicTakeBestOrder","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [direction, market, outcome, fxpAmount, price, tradeGroupID], options.sender);
        return <BN>result[0];
    }

    public publicBuy = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicBuy","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [market, outcome, fxpAmount, price, tradeGroupID], options.sender, options.gasPrice);
    }

    public publicBuy_ = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicBuy","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [market, outcome, fxpAmount, price, tradeGroupID], options.sender);
        return <string>result[0];
    }

    public publicTrade = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicTrade_ = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_direction","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicTrade","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [direction, market, outcome, fxpAmount, price, tradeGroupID], options.sender);
        return <string>result[0];
    ...
    public publicSell = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicSell","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [market, outcome, fxpAmount, price, tradeGroupID], options.sender, options.gasPrice);
    }

    public publicSell_ = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupID: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupID","type":"uint256"}],"name":"publicSell","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [market, outcome, fxpAmount, price, tradeGroupID], options.sender);
        return <string>result[0];
...
export class ITradingEscapeHatch extends Contract {
    public constructor(connector: Connector, accountManager: AccountManager, address: string, defaultGasPrice: BN) {
        super(connector, accountManager, address, defaultGasPrice);
    }

    public claimSharesInUpdate = async(arg0: string, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"}],"name":"claimSharesInUpdate","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        return await this.remoteCall(abi, [arg0], options.sender, options.gasPrice);
    }

    public claimSharesInUpdate_ = async(arg0: string, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"","type":"address"}],"name":"claimSharesInUpdate","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [arg0], options.sender);
        return <boolean>result[0];
...
export class Orders extends Controlled {
    ...
    public getOrderId_ = async(type: BN|number, market: string, amount: BN|number, price: BN|number, sender: string, blockNumber: BN|number, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
    ...
    public saveOrder = async(type: BN|number, market: string, amount: BN|number, price: BN|number, sender: string, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public saveOrder_ = async(type: BN|number, market: string, amount: BN|number, price: BN|number, sender: string, outcome: BN|number, moneyEscrowed: BN|number, sharesEscrowed: BN|number, betterOrderId: string, worseOrderId: string, tradeGroupId: BN|number, options?: { sender?: string }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_type","type":"uint8"},{"name":"_market","type":"address"},{"name":"_amount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_sender","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_moneyEscrowed","type":"uint256"},{"name":"_sharesEscrowed","type":"uint256"},{"name":"_betterOrderId","type":"bytes32"},{"name":"_worseOrderId","type":"bytes32"},{"name":"_tradeGroupId","type":"uint256"}],"name":"saveOrder","outputs":[{"name":"_orderId","type":"bytes32"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
...
export class OrdersFetcher extends Controlled {
    ...
    public descendOrderList_ = async(type: BN|number, price: BN|number, highestOrderId: string, options?: { sender?: string }): Promise<Array<string>> => {
        options = options || {};
    ...
    public ascendOrderList_ = async(type: BN|number, price: BN|number, lowestOrderId: string, options?: { sender?: string }): Promise<Array<string>> => {
        options = options || {};
...
export class ShareToken extends Controlled {
    ...
    public createShares = async(owner: string, fxpValue: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public createShares_ = async(owner: string, fxpValue: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_owner","type":"address"},{"name":"_fxpValue","type":"uint256"}],"name":"createShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
    ...
    public destroyShares = async(owner: string, fxpValue: BN|number, options?: { sender?: string, gasPrice?: BN }): Promise<string> => {
        options = options || {};
    ...
    public destroyShares_ = async(owner: string, fxpValue: BN|number, options?: { sender?: string }): Promise<boolean> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_owner","type":"address"},{"name":"_fxpValue","type":"uint256"}],"name":"destroyShares","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"};
        const result = await this.localCall(abi, [owner, fxpValue], options.sender);
        return <boolean>result[0];
...
export class Trade extends Controlled {
    ...
    public publicTakeBestOrder = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicTakeBestOrder_ = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<BN> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_direction","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicTakeBestOrder","outputs":[{"name":"","type":"uint256"}],"payable":true,"stateMutability":"payable","type":"function"};
    ...
    public publicBuy = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicBuy_ = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicBuy","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
    ...
    public publicTrade = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_direction","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicTrade","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
        return await this.remoteCall(abi, [direction, market, outcome, fxpAmount, price, tradeGroupId], options.sender, options.gasPrice, options.attachedEth);
    }

    public publicTrade_ = async(direction: BN|number, market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_direction","type":"uint8"},{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicTrade","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
        const result = await this.localCall(abi, [direction, market, outcome, fxpAmount, price, tradeGroupId], options.sender, options.attachedEth);
        return <string>result[0];
    ...
    public publicSell = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, gasPrice?: BN, attachedEth?: BN }): Promise<string> => {
        options = options || {};
    ...
    public publicSell_ = async(market: string, outcome: BN|number, fxpAmount: BN|number, price: BN|number, tradeGroupId: BN|number, options?: { sender?: string, attachedEth?: BN }): Promise<string> => {
        options = options || {};
        const abi: AbiFunction = {"constant":false,"inputs":[{"name":"_market","type":"address"},{"name":"_outcome","type":"uint8"},{"name":"_fxpAmount","type":"uint256"},{"name":"_price","type":"uint256"},{"name":"_tradeGroupId","type":"uint256"}],"name":"publicSell","outputs":[{"name":"","type":"bytes32"}],"payable":true,"stateMutability":"payable","type":"function"};
        const result = await this.localCall(abi, [market, outcome, fxpAmount, price, tradeGroupId], options.sender, options.attachedEth);
        return <string>result[0];
