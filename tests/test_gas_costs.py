...
def test_marketCreation(localFixture, universe, cash):
    ...
    with PrintGasUsed(localFixture, "ReportingWindow:createMarket", MARKET_CREATION):
        marketAddress = reportingWindow.createBinaryMarket(endTime, feePerEthInWei, denominationToken.address, designatedReporterAddress, "", "", value = marketCreationFee, startgas=long(6.7 * 10**6))
