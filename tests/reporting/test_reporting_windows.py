...
def test_reporting_window_create_market(localFixture, chain, mockUniverse, mockMarket, mockCash, mockReputationToken, mockParticipationToken):
    ...
    with raises(TransactionFailed, message="start time is less than current block time"):
        newMarket = reportingWindow1.createMarket(endTimeValue, numOutcomesValue, numTicks, feePerEthInWeiValue, mockCash.address, designatedReporterAddressValue)
    ...
    with raises(TransactionFailed, message="reporting window not associated with universe"):
        newMarket = reportingWindow2.createMarket(endTimeValue, numOutcomesValue, numTicks, feePerEthInWeiValue, mockCash.address, designatedReporterAddressValue)
    ...
    newMarket = reportingWindow3.createMarket(endTimeValue, numOutcomesValue, numTicks, feePerEthInWeiValue, mockCash.address, designatedReporterAddressValue)
