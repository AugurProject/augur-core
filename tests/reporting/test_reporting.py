...
def test_reporting(contractsFixture):
    ...
    contractsFixture.state.block.timestamp = reportingWindow.getStartTime() + 1
    ...
    # contest the results
    contractsFixture.state.block.timestamp = reportingWindow.getDisputeStartTime() + 1
    ...
    # finalize
    contractsFixture.state.block.timestamp = branch.getForkEndTime() + 1
    market.tryFinalize()
