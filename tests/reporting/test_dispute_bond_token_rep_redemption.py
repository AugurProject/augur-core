...
LAST_REPORTERS_DISPUTE_BOND_AMOUNT = 1375 * 10**20
...
@mark.parametrize('designatedReporterAccountNum,designatedReporterOutcome,designatedReporterDisputerAccountNum,designatedReporterDisputeStakes,firstReportersDisputerAccountNum,firstReporterDisputeOutcome,firstReportersDisputeStakes,lastReportersDisputerAccountNum,lastReportersDisputeStakes,expectedAccountBalances', [
    ...
    (0, SCALAR_OUTCOME_A, None, [], None, None, [], None, [], [[0, None, 1000000 * REP_DIVISOR], [1, None, 1000000 * REP_DIVISOR]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[2, SCALAR_OUTCOME_A, 1105 * REP_DIVISOR]], None, None, [], None, [], [[0,  None, 1000003987353206865401987], [1, None, 998899999999999999999999], [2, None, 1001098012646793134598014]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 1205 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 100 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 100 * REP_DIVISOR]], None, None, [], None, [], [[0, None, 1001302000000000000000001], [1, None, 998799999999999999999999], [2, None, 999900000000000000000000]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 100 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 105 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 100 * REP_DIVISOR]], None, None, [], None, [], [[0, None, 999900000000000000000000], [1, None, 1000202000000000000000000], [2, None, 999900000000000000000000]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 2500 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 1500 * REP_DIVISOR], [2, SCALAR_OUTCOME_B, 1500 * REP_DIVISOR], [3, SCALAR_OUTCOME_C, 1500 * REP_DIVISOR]], None, None, [], None, [], [[0, None, 997500000000000000000000], [1, None, 1002551000000000000000000], [2, None, 1001451000000000000000000], [3, None, 998500000000000000000000]]),
    # No losing tokens; bond holder was right (bond holder gets 1x back, winning tokens get no bonus)
    (0, SCALAR_OUTCOME_A, 1, [[1, SCALAR_OUTCOME_B, 200 * REP_DIVISOR], [2, SCALAR_OUTCOME_B, 100 * REP_DIVISOR]], None, None, [], None, [], [[0,  None, 1000000000000000000000000], [1, None, 1000002000000000000000000], [2, None, 1000000000000000000000000]]),

    # Test cases where designated reporter & first reporters are disputed
    # No losing tokens; bond holder was incorrect (bond holder gets nothing back, correct token holders get bonus)
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 1105 * REP_DIVISOR]], 2, SCALAR_OUTCOME_B, [[3, SCALAR_OUTCOME_A, 11050 * REP_DIVISOR]], None, [], [[0, None, 1001103809656987743686764], [1, None, 998899999999999999999999], [2, None, 989000000000000000000000], [3, None, 1010998190343012256313237]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 1305 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 100 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 100 * REP_DIVISOR]], 2, SCALAR_OUTCOME_B, [[3, SCALAR_OUTCOME_A, 11005 * REP_DIVISOR]], None, [], [[0, None, 1001307726120857699805068], [1, None, 998799999999999999999999], [2, None, 988900000000000000000000], [3, None, 1010994273879142300194933]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 1305 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 100 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 100 * REP_DIVISOR]], 2, SCALAR_OUTCOME_B, [[3, SCALAR_OUTCOME_B, 150 * REP_DIVISOR]], None, [], [[0, None, 998695000000000000000000], [1, None, 1001100000000000000000000], [2, None, 1000207000000000000000000], [3, None, 1000000000000000000000000]]),
    ...
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 25000 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 105 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 100 * REP_DIVISOR]], 1, SCALAR_OUTCOME_B, [[3, SCALAR_OUTCOME_B, 25000 * REP_DIVISOR]], None, [], [[0, None, 975000000000000000000000], [1, None, 1012154380003983270264887], [2, None, 999900000000000000000000], [3, None, 1012947619996016729735113]]),
    # No losing tokens; first bond holder was right (first bond holder get 1x back, winning tokens get no bonus)
    (0, SCALAR_OUTCOME_A, 1, [[2, SCALAR_OUTCOME_B, 105 * REP_DIVISOR]], 0, SCALAR_OUTCOME_C, [[3, SCALAR_OUTCOME_B, 11150 * REP_DIVISOR]], None, [], [[0, None, 988999999999999999999999], [1, None, 1000002000000000000000001], [2, None, 1000102621057307863171923], [3, None, 1010897378942692136828077]]),
    # Some losing tokens; some winning tokens; bond holders were correct; No reporting during the last reporting phase
    (0, SCALAR_OUTCOME_A, 1, [[1, SCALAR_OUTCOME_B, 2000 * REP_DIVISOR], [2, SCALAR_OUTCOME_C, 50 * REP_DIVISOR]], 2, None, [], None, [], [[0, None, 1000000000000000000000000], [1, None, 999099999999999999999999], [2, None, 1000902000000000000000001], [3, None, 1000000000000000000000000]]),
    # Some losing tokens; some winning tokens; bond holders were incorrect; No reporting during the last reporting phase
    (0, SCALAR_OUTCOME_A, 1, [[0, SCALAR_OUTCOME_A, 12200 * REP_DIVISOR], [1, SCALAR_OUTCOME_B, 50 * REP_DIVISOR]], 2, None, [], None, [], [[0, None, 1012152000000000000000001], [1, None, 998849999999999999999999], [2, None, 989000000000000000000000], [3, None, 1000000000000000000000000]]),
...
def test_dispute_bond_tokens(designatedReporterAccountNum, designatedReporterOutcome, designatedReporterDisputerAccountNum, designatedReporterDisputeStakes, firstReportersDisputerAccountNum, firstReporterDisputeOutcome, firstReportersDisputeStakes, lastReportersDisputerAccountNum, lastReportersDisputeStakes, expectedAccountBalances, contractsFixture, universe, binaryMarket, categoricalMarket, scalarMarket):
    ...
    if (len(designatedReporterOutcome) > 0):
        ...
        if (designatedReporterDisputerAccountNum != None):
            ...
            buyStakeTokens(designatedReporterDisputeStakes, reputationToken, stakeTokenA, stakeTokenB, stakeTokenC)
    ...
    if (firstReportersDisputerAccountNum != None):
        ...
        # Have test accounts report on the outcome
        buyStakeTokens(firstReportersDisputeStakes, reputationToken, stakeTokenA, stakeTokenB, stakeTokenC)
...
def buyStakeTokens(disputeStakes, reputationToken, stakeTokenA, stakeTokenB, stakeTokenC):
