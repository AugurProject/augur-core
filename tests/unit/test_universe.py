...
def test_universe_contains(localFixture, populatedUniverse, mockMarket, mockStakeToken, chain, mockFeeWindow, mockDisputeBond, mockShareToken, mockFeeWindowFactory):
