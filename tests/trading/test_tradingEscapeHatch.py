...
from utils import fix, longTo20Bytes
...
def test_escapeHatch(contractsFixture):
    ...
    orderID = makeOrder.publicMakeOrder(ASK, fix('1'), fix('0.6'), market.address, YES, longTo20Bytes(0), longTo20Bytes(0), 42, sender=tester.k1)
    assert orderID
