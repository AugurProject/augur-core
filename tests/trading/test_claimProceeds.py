...
def test_redeem_shares_in_binary_market(fundedRepFixture):
    ...
    initialOwnerBalance = fundedRepFixture.utils.getETHBalance(tester.a0)
    cash = fundedRepFixture.cash
    ...
    assert fundedRepFixture.utils.getETHBalance(tester.a0) - initialOwnerBalance == expectedFees.mul(market.getMarketCreatorSettlementFeeInAttoethPerEth()).div(1 ether)
